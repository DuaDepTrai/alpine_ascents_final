...
<div class="container">
    <div class="button_container">
        <button id="btn_overview_history">Overview and History</button>
        <button id="btn_types_and_forms">Types and Forms</button>
        <button id="btn_technique">Technique</button>
        <button id="btn_shelter">Shelter</button>
        <button id="btn_danger">Danger</button>
        <button id="btn_record">Records</button>
    </div>

    <div class="content_container">
        <div class="overview_history" id="overview_history">
            <h3>Overview</h3>
        ...
        <div class="types_and_forms" id="types_and_forms">
            <h3>Walking</h3>
        ...
        <div class="technique" id="technique">
            ...
            <h4>Pacing and Breathing Technique</h4>
            ...
            <h4>Footwork and Grip Technique</h4>
            ...
            <h4>Gear Management Technique</h4>
...
<script>
    document.addEventListener('DOMContentLoaded',function(){
        var overview_history = document.getElementById('overview_history');
        var types_and_forms = document.getElementById('types_and_forms');
        var technique = document.getElementById('technique');
        var shelter = document.getElementById('shelter');
        var danger = document.getElementById('danger');
        var record = document.getElementById('record');

        var btn_overview_history = document.getElementById('btn_overview_history');
        var btn_types_and_forms = document.getElementById('btn_types_and_forms');
        var btn_technique = document.getElementById('btn_technique');
        var btn_shelter = document.getElementById('btn_shelter');
        var btn_danger = document.getElementById('btn_danger');
        var btn_record = document.getElementById('btn_record');

        function resetDisplay(){
            overview_history.style.display = "none";
            types_and_forms.style.display = "none";
        ...
        function resetColor() {
            btn_overview_history.style.backgroundColor = "#5c715e";
            btn_types_forms.style.backgroundColor = "#5c715e";
            btn_technique.style.backgroundColor = "#5c715e";
            btn_shelter.style.backgroundColor = "#5c715e";
            btn_danger.style.backgroundColor = "#5c715e";
            btn_record.style.backgroundColor = "#5c715e";
        }

        resetDisplay();
        btn_overview_history.addEventListener('click',function(){
            resetDisplay();
            overview_history.style.display = "block";
            resetColor();
            btn_overview_history.style.backgroundColor = "#ddeedf";
        });
    });
...
<style>
    ...
    /* .overview_history,.types_and_forms,
    .technique,.shelter,.danger,.record{
        display: none;
    } */
