...
<body
    class="page-template page-template-template-tabs page-template-template-tabs-php page page-id-128 page-parent page-child parent-pageid-2 theme-alpine-ascents woocommerce-no-js wp-schema-pro-2.7.20 group-blog">
                                ...
                                <li
                                    ...
                                    <ul class="ubermenu-submenu ubermenu-submenu-id-6514 ubermenu-submenu-type-stack">
                                        ...
                                        <li id="menu-item-6526"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href=""><span
                                                    class="ubermenu-target-title ubermenu-target-text">Phong Nha Ke Bang</span></a>
                                        </li>
                                        <li id="menu-item-6527"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href=""><span
                                                    class="ubermenu-target-title ubermenu-target-text">Ta Xua</span></a>
                                        </li>
                                        <li id="menu-item-6528"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href=""><span
                                                    class="ubermenu-target-title ubermenu-target-text">Thac Ban Gioc</span></a>
                                        </li>
                                        <li id="menu-item-6529"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href=""><span
                                                    class="ubermenu-target-title ubermenu-target-text">Cot Co Lung Cu</span></a>
                                        </li>
                                        <li id="menu-item-100217"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href=""><span
                                                    class="ubermenu-target-title ubermenu-target-text">Yen Tu</span></a>
                                        </li>
                                        <li id="menu-item-6531"
                                            ...
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href="https://www.alpineascents.com/climbs/mount-vinson/"><span
                                                    class="ubermenu-target-title ubermenu-target-text">Lang Biang</span></a>
                                        </li>
                                        <li id="menu-item-6531"
                                            class="ubermenu-item ubermenu-item-type-post_type ubermenu-item-object-page ubermenu-item-6531 ubermenu-item-auto ubermenu-item-normal ubermenu-item-level-3 ubermenu-column ubermenu-column-auto">
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
                                                href="https://www.alpineascents.com/climbs/mount-vinson/"><span
                                                    class="ubermenu-target-title ubermenu-target-text">Ba Den Mountain</span></a>
                                        </li>
                                        <li id="menu-item-6531"
                                            class="ubermenu-item ubermenu-item-type-post_type ubermenu-item-object-page ubermenu-item-6531 ubermenu-item-auto ubermenu-item-normal ubermenu-item-level-3 ubermenu-column ubermenu-column-auto">
                                            <a class="ubermenu-target ubermenu-item-layout-default ubermenu-item-layout-text_only"
    ...
    <div class="banner-image">
        <div class="header-image"
            style="background-repeat: no-repeat; background-size: cover; background-position: top center; background-image: url('images/fansipan/fansipan (1).png');;">
            <div class="header-text-wrapper">
                <div class="header-text"> <span>
                        <h3>Fansipan</h3>
                        <h6>(10,360.5 ft/ 3.147,3 m) Hoang Lien Son</h6>
                            ...
                            <div id="about" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        <h2 class="section-title">Climb Mount Fansipan With Alpine Ascents in 2025
                                            Season</h2>
                                        <blockquote>
                                            <p>Awesome trip! I cannot recommend Alpine Ascents enough! Thank you so much
                                                to the whole staff! - 2024 Fansipan Climber</p>
                                            <p>Fansipan was completely amazing. Ben is an outstanding guide and the
                                                whole
                                                ...
                                                much! - 2023 Everest Climber</p>
                                        </blockquote>
                                        <p>With guide Ben Jones leading the way and selecting a summit day, our 2022,
                                            2023, and 2024 teams had an incredible summit day with clear skies and
                                            figuratively had the summit to themselves! Ben’s 2024 team had 100% success
                                        </p>
                                        <p>We encourage you to chat with former Everest team members! And we also offer
                                            <a href="/climbs/mount-everest/itinerary/#camp-ii">a Camp II climb</a>
                                        </p>
                                        <blockquote>
                                            <p>Ben, the Sherpa, and other AAI staff all did great and I couldn’t have
                                                asked for a better climbing experience.</p>
                                            <p>Ben did a great job and the entire staff was fantastic to be around. AAI
                                                went above and beyond the whole trip. Thank you for providing such a
                                                great experience.</p>
                                            <p>Alpine Ascents is the cream of the crop on Everest. From the guides to
                                                the organization to the infrastructure – we have the best. This is just
                                                one small example of the kind of care and attention to detail that AAI
                                                has. I am truly grateful to be here and on this team.</p>
                                        </blockquote>
                                        <blockquote>
                                            <p>For most people, Everest is a once-in-a-lifetime experience because of
                                                the costs, the time invested, etc. If you’re considering giving it a
                                                shot — go with the best possible service provider. Alpine Ascents’
                                                logistics, guides, and Sherpa team are absolutely top-notch.” – Alison
                                                Levine, Alpine Ascents Everest team, author of the New York Times
                                                bestsellerÂ <a
                                                    href="https://www.amazon.com/Edge-Leadership-Lessons-Everest-Environments/dp/1455544876/ref=sr_1_1?ie=UTF8&qid=1447969791&sr=8-1&keywords=on+the+edge"><em>ON
                                                        THE EDGE</em></a><em>, featured onÂ </em><a
                                                    href="http://bit.ly/1nALxTc"><em>60 Minutes Sports</em></a></p>
                                        </blockquote>
                                        <h2>Location</h2>
                                        <p>Fansipan, located in Sa Pa district, Lao Cai province, is known as the "Roof
                                            of Indochina", the highest peak in the Hoang Lien Son range, with an
                                            altitude of 3,143 meters above sea level.</p>
                                        <p>This place attracts conquerors not only because of its greatness but also
                                            because of its majestic natural beauty. Fansipan is a dream destination for
                                            many trekkers and tourists, bringing a sense of victory when standing on the
                                            highest peak of Indochina, immersing yourself in the sea of ​​white clouds
                                            and admiring the vast surrounding landscape. </p>
                                    </div><!-- .sb-content -->
                                </div><!-- .sb-content-wrapper -->
                                <div class="sidebar">
                                    <div class="widget">
                                        <h2 class='actnew'>Climb Mount Fansipan Prices</h2>
                                        <p><strong>Fansipan South Col</strong><br /> $76,000 (<em>based on 5 climber
                                                team</em>)</p>
                                        <p><strong>Fansipan + Lhotse</strong><br /> $89,500</p>
                                        <p><strong>Fansipan Camp II</strong><br /> $13,000</p>
                                    </div><!-- .widget -->
                                    <div class="widget">
                                        <h2 class='actnew'>Climb Mount Fansipan Schedules</h2>
                                        <p><strong>Fansipan South Col</strong><br /> <strong><em>2025
                                                    Schedule</em></strong><br /> April 3 – June 3, 2025<br /> Lead
                                            Guide: <a href="https://www.alpineascents.com/guides/ben-jones/">Ben
                                                Jones</a></p>
                                        <p><strong>Fansipan + Lhotse<br /> <em>2025 Schedule</em></strong><br /> April 3
                                            – June 3, 2025<br /> Lead Guide: <a
                                                href="https://www.alpineascents.com/guides/ben-jones/">Ben Jones</a>
                                        </p>
                                        <p><strong>Fansipan Camp II<br /> <em>2025 Schedule</em></strong><br /> April 3
                                            –
                                    ...
                                    <div class="widget">
                                        ...
                                        <p><strong>Check the weather before departure to ensure favorable conditions.</strong><br /></p>
                                        <p><strong>Follow the instructions of the guides, do not deviate from the route.</strong><br /></p>
                                        <p><strong>Wear protective gear to avoid injury and keep your surroundings clean.</strong><br /></p>
                                    </div><!-- .widget -->
                                </div><!-- .sidebar -->
                            </div><!-- #about -->
                            <div id="Feature" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        <h2 class="section-title">Climb Mount Fansipan With Alpine Ascents in 2025
                                            Season</h2>
                                        <p>Fansipan has a rugged limestone terrain with steep and bumpy roads.</p>
                                        <p>Along the way to the top, you will pass through dense forests, clear streams,
                                            and green grasslands. The road to the top is often covered in mist, creating
                                            a mysterious and majestic scene. Small caves and beautiful waterfalls along
                                            the route are also interesting highlights.</p>
                                        <p>The rainy season can make the road more slippery and difficult, but in
                                            return, the natural scenery is beautiful and the air is fresh. </p>
                                    </div><!-- .sb-content -->
                                </div><!-- .sb-content-wrapper -->
                                <div class="sidebar">
                                    <div class="widget">
                            ...
                            <div id="Best_Time" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        ...
                                        <p>The ideal time to conquer Fansipan is from October to April. </p>
                                        <p>During this period, the weather is dry and cool, with temperatures ranging
                                            from 10 to 20 degrees Celsius, which is ideal for trekking. </p>
                                        <p>Spring and autumn are the best times to see the scenery, with brilliant
                                            yellow fields of wild sunflowers or the green of the vegetation. Summer can
                                            be rainy, affecting travel and sightseeing. Winter can be very cold and
                                            there may be snow and ice, making the conquest more difficult and requiring
                            ...
                            <div id="Checking_Routes" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        ...
                                        <p>Starting from the foot of the mountain, the journey will take you through
                                            winding trails through dense forests and beautiful valleys. Along the way,
                                            you will have the opportunity to admire the majestic scenery and experience
                                            the distinct change in climate and landscape from the foot of the mountain
                                            to the top. On the first night, you will stay at temporary camps or lodges
                                            in the middle of the mountain to regain your strength. </p>
                                        <p>On the second day, you will continue to conquer the steep slopes and cloud
                                            forests to reach the top of Fansipan, where you will enjoy the majestic
                                            panorama of Hoang Lien Son range. </p>
                                    </div><!-- .sb-content -->
                                </div><!-- .sb-content-wrapper -->
                                <div class="sidebar">
                                    <div class="widget">
                            ...
                            <div id="Direction" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        ...
                                        <p>Take a train or bus from Hanoi to Sa Pa, the travel time is about 6-8 hours.
                                        </p>
                                        <p>From Sa Pa, rent a motorbike or taxi to travel to the foot of the mountain.
                                        </p>
                                    </div><!-- .sb-content -->
                                </div><!-- .sb-content-wrapper -->
                                <div class="sidebar">
                            ...
                            <div id="Essential_Items" class="tab-content">
                                <div class="sb-content-wrapper">
                                    <div class="sb-content">
                                        ...
                                        <p>Waterproof and non-slip trekking shoes</p>
                                        ...
                                        <p>Warm clothes and woolen hats if traveling in winter</p>
                                    </div><!-- .sb-content -->
                                </div><!-- .sb-content-wrapper -->
                                <div class="sidebar">
                                    <div class="widget">
    ...
    <div class="jp-carousel-overlay" style="display: none;">
        <div class="jp-carousel-container"> <!-- The Carousel Swiper -->
            <div class="jp-carousel-wrap swiper-container jp-carousel-swiper-container jp-carousel-transitions"
                ...
                <div class="jp-swiper-button-prev swiper-button-prev"> <svg width="25" height="24"
                ...
                <div class="jp-swiper-button-next swiper-button-next"> <svg width="25" height="24"
                        viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </div> <!-- The main close buton -->
            <div class="jp-carousel-close-hint"> <svg width="25" height="24" viewBox="0 0 25 24"
                ...
                </svg></div> <!-- Image info, comments and meta -->
            <div class="jp-carousel-info">
                <div class="jp-carousel-info-footer">
                    ...
                    <div class="jp-carousel-photo-icons-container"> <a href="#"
                            class="jp-carousel-icon-btn jp-carousel-icon-info"
                            aria-label="Toggle photo metadata visibility"> <span class="jp-carousel-icon"> <svg
                            ...
                            class="jp-carousel-icon-btn jp-carousel-icon-comments"
                            aria-label="Toggle photo comments visibility"> <span class="jp-carousel-icon"> <svg
                                    width="25" height="24" viewBox="0 0 25 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="jp-carousel-comments-wrapper">
                            ...
                            <div id="jp-carousel-comment-form-container"> <span
                                ...
                                <form id="jp-carousel-comment-form"> <label
                                        for="jp-carousel-comment-form-comment-field" class="screen-reader-text">Write
                                        a Comment...</label><textarea name="comment"
                                        class="jp-carousel-comment-form-field jp-carousel-comment-form-textarea"
                                        id="jp-carousel-comment-form-comment-field" placeholder="Write a Comment...">
