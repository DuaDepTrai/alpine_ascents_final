...
<body>
    <div class="container w-50 mx-auto mt-3">
        ...
        <form action="{{ route('sendVerificationCode') }}" method="post" class="form-control p-3">
            @csrf
            <p>Please enter your email.</p>
            <input type="email" name="email" class="form-control" placeholder="Your current email" required>
