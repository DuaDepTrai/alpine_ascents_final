    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Add New Branch
                    <small>Add information of new branch into system</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{ route('admin.branches.index') }}">Branches Management System</a></li>
                            ...
                            <div class="box-body">
                                ...
                                <form method="POST" action="{{ route('admin.branches.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="positioning" id="positioning" class="form-control" value="{{ old('positioning') }}">
                                        @error('positioning')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
