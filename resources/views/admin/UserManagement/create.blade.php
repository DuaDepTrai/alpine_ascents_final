        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3>Add New User <small>Add new user information to the system</small></h3>
              </div>
              <div class="icon"></div>
            </div>
            <!-- Form Start -->
            <form method="POST" action="{{ route('admin.UserManagement.store') }}">
              ...
              <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" required>
                  <option value="">Chọn quyền</option>
                  <option value="0" {{ old('status') == 0 ? 'selected' : '' }}>Not Activated</option>
                  <option value="1" {{ old('status') == 1 ? 'selected' : '' }}>Activated</option>
                </select>
                @error('status')
                <span class="text-danger">{{ $message }}</span>
                @enderror
